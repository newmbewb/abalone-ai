...
if __name__ == '__main__':
    ...
    generator = DataGenerator(
        encoder, 1024, f'../data/rl_mcts/generation{generation}_manual/{mode}_dataset',
        f'../data/rl_mcts/generation{generation}_manual/encoded_data', mode, 0.2)

    # Simple network
    prepare_tf_custom_objects()
    model_generator = ac_simple1_v2.ACSimple1(mode, dropout_rate=dropout_rate, data_format="channels_last")
    ...
    model = load_model(
        '../data/checkpoints/gen03_ACSimple1v2Policy_dropout0.3_FourPlaneEncoder_channels_last_1st_sgd_epoch_35.h5')
    ...
    model.fit_generator(
        ...
        callbacks=[
            ModelCheckpoint(f'../data/checkpoints/gen{generation}_{network_name}_3rd_sgd_epoch_{{epoch}}.h5')
