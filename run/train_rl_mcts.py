...
def main():
    ...
    while True:
        ...
        if stage == 1:
            ...
            # Train data
            gc.collect()
            old_policy_model = load_model(old_policy_model_path)
            old_policy_model.fit_generator(
            ...
            # Train data
            old_value_model = load_model(old_value_model_path)
            gc.collect()
            old_value_model.fit_generator(
                generator=generator.generate('train'),
                epochs=value_epochs,
                steps_per_epoch=generator.get_num_steps('train'),
                validation_data=generator.generate('test'),
